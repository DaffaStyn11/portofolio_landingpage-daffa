...
@section('header', 'Tambah About Baru')
...
<div class="max-w-3xl">
    ...
    <form action="{{ route('admin.abouts.store') }}" method="POST" class="bg-white rounded-lg shadow p-6">
        @csrf

        <div class="mb-4">
            <label class="block text-sm font-medium text-gray-700 mb-2">Judul *</label>
            <input type="text" name="title" value="{{ old('title') }}" placeholder="Tentang Saya" required
        ...
        <div class="mb-4">
            ...
            <input type="text" name="years_experience" value="{{ old('years_experience') }}" placeholder="1" required
                   class="w-full px-3 py-2 border border-gray-300 rounded focus:ring-2 focus:ring-blue-500">
        </div>

        <div class="mb-4">
            <label class="block text-sm font-medium text-gray-700 mb-2">Projects Completed *</label>
            <input type="text" name="projects_completed" value="{{ old('projects_completed') }}" placeholder="10+" required
                   class="w-full px-3 py-2 border border-gray-300 rounded focus:ring-2 focus:ring-blue-500">
        </div>

        <div class="mb-4">
            <label class="block text-sm font-medium text-gray-700 mb-2">Image Path</label>
            <input type="text" name="image" value="{{ old('image') }}" placeholder="images/projects/fotoprofile.png"
                   class="w-full px-3 py-2 border border-gray-300 rounded focus:ring-2 focus:ring-blue-500">
